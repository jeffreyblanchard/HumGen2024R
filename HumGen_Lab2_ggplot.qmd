...
Today we will walk through Chapter 1 of R for Data Science. By **putting the examples and exercises** in our own Quarto Markdown file, we can create own personal path through the Chapter. We will do all sections, except `1.6 Saving your plots` which we will learn later. In section `1.2` you only need to do exercises 1-5, 9 and 10. Make are readable report by delineating the sections (e.g. 1.2.3 Creating a ggplot) with hashtags so they are visible in your report outline.
