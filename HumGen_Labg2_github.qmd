---
title: "Lab g2: Connecting a Github repo site with a new RStudio project"
---
...
`git` is installed on Posit Cloud, Unity and most unix systems. If you are working on your own computer using MacOSX or Windows you will need to install `git`. Follow the directions on the [GitHub site](https://github.com/git-guides/install-git).
